...
\title{PRIMUS: {\bf Effects of} Galaxy Environment on the Quiescent Fraction Evolution at \lowercase{\textit{z}}$<0.8$}
\author{
...
\begin{figure*}
  \begin{center}
    \leavevmode
    \epsfig{file=fig3.pdf, height=0.75\textwidth}
...
{\bf However, the uncertainties in the PRIMUS redshifts may contaminate 
...
{\bf Due to the redshift uncertainties in PRIMUS, our galaxy environment measures are more susceptible to contamination. Furthermore, as discussed in \cite{Coil:2011aa} and \cite{Cool:2013aa}, PRIMUS has a targeting fraction of $\sim 80 \%$ and redshift success rate of $> 75 \%$. zCOSMOS, in comparison, has $88 \%$ redshift completeness for the entire sample and $95 \%$ complete within the redshift range $0.5 < z < 0.8$ (\citealt{Lilly:2009aa}).}While the zCOSMOS survey provides more precise spectroscopic redshifts than PRIMUS, our sample provides significantly larger statistics. In addition, our sample covers a larger portion of the sky. Our SDSS-{\em GALEX} sample covers $2,505 \;\mathrm{deg}^2$. More comparably, our PRIMUS sample covers $5.5 \;\mathrm{deg}^2$, over 3 times the sky coverage of zCOSMOS ($1.7 \;\mathrm{deg}^2$). Furthermore, our PRIMUS sample is constructed from five independent fields which allows us to significantly reduce the effects of cosmic variance.
...
\begin{enumerate}
    ...
    {\bf for $\mathcal{M} \sim 10^{10.5} -10^{11} \mathcal{M}_\odot$ and out to redshift $z\sim 0.7$}. This result
...
\bibitem[{{Charlot} \& {Fall}(2000)}]{Charlot:2000aa}
{Charlot}, S. and {Fall}, S.~M. 2000, \apj, 539, 718
...
\bibitem[{{Driver} {et~al.}(2010){Driver}, \&{Robotham}}]{Driver:2010aa}
{Driver}, S.~P. and {Robotham}, A.~S.~G. 2010, \mnras, 407, 2131
