...
\title{PRIMUS: Galaxy Environment on the Quiescent Fraction Evolution at \lowercase{\textit{z}}$<0.8$}
\author{
...
\begin{figure*}
  \begin{center}
    \leavevmode
    \epsfig{file=fig3.eps, height=0.75\textwidth,angle=90}
...
\begin{figure*}
    \begin{center}
        \leavevmode
        \epsfig{file=fig4.eps, height=0.75\textwidth,angle=90}
...
\begin{figure}
    \begin{center}
        \leavevmode
        \epsscale{1.0}
        \epsfig{file=fig5, height=0.45\textwidth}
...
\begin{figure*}
    \begin{center}
        \leavevmode
        \epsscale{1.0}
        \epsfig{file=fig6.eps, height=\textwidth, angle=90}
