...
$0.6-0.8$      &Low           &1158                       &2303                           \\
  ...
  \multicolumn{4}{l}{}                                             \\       
    \end{tabular} \par
    \bigskip 
    {\bf Notes}: Number of galaxies in the mass complete subsamples derived in Section \ref{sec:sample}. The subsamples are classified based on environment and star formation rate. The lowest redshift bin is derived from SDSS; the rest are from PRIMUS. 
  \end{center}
\end{table}
