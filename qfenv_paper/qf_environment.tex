...
\begin{figure*}
    \begin{center}
        ...
        \label{fig:smf}
        \epsscale{1.0}
        \plotone{fig_smf_cylr2h25_thresh75_bin0_25.png}
        \caption{Stellar mass functions for galaxies in the $30$ subsamples divided into redshift bins, $0.06-0.145$ (green), $0.2-0.4$ (red), $0.4-0.6$ 
...
\begin{figure*}
    \begin{center}
        ...
        \label{fig:smf}
        \epsscale{1.0}
        \plotone{fig_qf_cylr2h25_thresh75_bin0_25.png}
...
\begin{figure}
    \begin{center}
        \leavevmode
        \epsscale{1.0}
        \plotone{fig_qffit_cylr2h25_thresh75_bin0_25.eps}
        \label{fig:qf}
...
\begin{figure*}
    \begin{center}
        \leavevmode
        \epsscale{1.0}
        \plotone{fig_qffit_cylr1h25_thresh80_bin0_25.eps}
        \label{fig:qf}
