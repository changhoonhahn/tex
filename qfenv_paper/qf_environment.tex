...
Although a direct comparison with other results is impossible due to our sample specific methodology, a number of results from literature have investigated the quiescent fraction. In this section we compare our $f_{\rm{Q}}$ results from above to a number of these results, specifically from SDSS and zCOSMOS, with comparably defined samples and analogous environment classifications. 
