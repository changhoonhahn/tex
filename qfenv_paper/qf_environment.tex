...
As a result, we note that the SMF redshift evolution is inconsistent when transition from the PRIMUS sample to the SDSS sample at $z \sim 0.2$. 

Yet, just from the PRIMUS samples alone, we probe a sufficient redshift range to observe certain trends in the SMF evolution for each of the panels in Figure \ref{fig:smf}. 
