...
The SMFs calculated in the previous section illustrate the stellar mass distribution of our galaxy population and its evolution over comic time. In this section, using the SMFs of our subsamples, we compare the quiescent and the star-forming populations using the quiescent fraction - the fraction of galaxies that have depleted their star-formation. With the sufficient statistics available from SDSS and PRIMUS, we evaluate the quiescent fraction in bins of stellar mass and redshift for low and high density environments. By analyzing the quiescent fraction with respect to mass, redshift, and environment we are able to compare the redshift evolution of the quiescent fraction for a complete mass range in our environments. Through this comparison we reveal the subtle effects of environment in quenching star formation that are often obscured by the underlying correlations among galactic properties such as color-mass and mass-density relations (\cite{Cooper:2010aa}). Furthermore by quantifying the environmental effects of star-formation quenching, we are able to provide constraints on the various proposed quenching mechanisms that operate on the scale of our environment measure, such as strangulation and ram-pressure stripping (CITECITE).
...
% SDSS QF matches with SDSS QF of Tinker et al. 2010 who uses a group catalog. The PRIMUS QF values match reasonably well with zCOSMOS 10k in Iovino et al. 2010 and zCOSMOS 20k in Kovac et al. 2014, once disparities between color classification and SFR classifications are taken into account. 

% The mass dependence of each subsample QF: reflects the color-mass relation and the morphology-mass relation
