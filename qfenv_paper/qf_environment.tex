...
\begin{figure*}
  \begin{center}
    \leavevmode
     ...
     \caption{NEED TO UPDATE WITH CORRECT SDSS MASS LIMIT. Evolution of stellar mass functions of star-forming (top) and quiescent (bottom) galaxies in 
...
%%% INCLUDE BRIEF QUALITATIVE ANALYSIS OF THE EVOLUTION OF THE QUIESCENT FRACTION
...
\begin{figure}
    \begin{center}
        \leavevmode
        \epsscale{1.0}
        \epsfig{file=fig_qffit_cylr2h25_thresh75_bin0_25_fidmass10_5_fixedslope_primuszerr.eps,height=0.5\textwidth}
        \label{fig:qf}
